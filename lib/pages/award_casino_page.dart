...
class AwardCasinoPage extends StatelessWidget {
  const AwardCasinoPage({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 40),
                  BlackContainerInformationComponent(
                    information: 'Gire e concorra a prêmios exclusivos!',
                  ),
                  SizedBox(height: 10),
                  SelectDrawComponent(),
                  SizedBox(height: 15),
                  WarningContainerComponent(
                    information: 'Você ainda não tem giros no Classic Slot!',
                  ),
                ],
              ),
            ),
